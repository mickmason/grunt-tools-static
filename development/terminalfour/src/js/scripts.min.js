 ...
 * Created by Michael Mason 
  */
!function(a){"use strict";/* Postition hero text in tablet and bigger devices  */
if(/* Lightbox modal - Ekko-lightbox */
$(document).on("click",'[data-toggle="lightbox"]',function(a){a.preventDefault(),$(this).ekkoLightbox({onContentLoaded:function(){console.log("loaded"),$(".modal-backdrop").addClass("ekko-lightbox")},alwaysShowClose:!0})}),/* 
     * Slick slider initialization
     * 
     */
$(".slick-gallery").slick({prevArrow:".arrow-left-icon.dfa-icon",nextArrow:".arrow-right-icon.dfa-icon",centerMode:!0,centerPadding:"20px"}),/* Handle mobile nav and search */
...
$("#search-submit-button").on("click",function(a){a.preventDefault(),$("#dfa-site-search-input").submit()}),$("#dfa-site-search-input").on("focus",function(a){var b=$(this).attr("placeholder");$(this).attr("placeholder",""),$(this).on("blur",function(a){$(this).attr("placeholder",b)})}),$(".hero-text")&&(console.log("there is a hero text element"),window.outerWidth>768)){var b=$(".hero-text"),c=b.attr("data-posx")?b.attr("data-posx"):50,d=b.attr("data-posy")?b.attr("data-posy"):50,e=b.attr("data-align")?b.attr("data-align"):"centre";b.css({left:c+"%",top:d+"%",textAlign:e}),$(a).on("resize",function(){b.css({left:c+"%",top:d+"%",textAlign:e})})}}(window);