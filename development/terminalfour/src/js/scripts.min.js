...
$(".secondary-nav-dropdown").on("click",function(a){a.preventDefault();var b=$(this),c=b.find(".secondary-nav__sub");b.hasClass("active")?(b.removeClass("active"),setTimeout(function(){c.slideUp({duration:120})},140)):(b.addClass("active"),setTimeout(function(){c.slideDown({duration:120})},140))}),/* Site-wide search handlers */
