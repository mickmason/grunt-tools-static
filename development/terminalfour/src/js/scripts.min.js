...
$(document).on("click",'[data-toggle="lightbox"]',function(a){a.preventDefault(),$(this).ekkoLightbox({onContentLoaded:function(){$(".modal-backdrop").addClass("ekko-lightbox")},alwaysShowClose:!0}),$(this).addClass("gallery-active")}),/* 
     ...
     * 
     */
$(".slick-gallery").slick({mobileFirst:!0,prevArrow:".arrow-left-icon.dfa-icon",nextArrow:".arrow-right-icon.dfa-icon",responsive:[{breakpoint:1024,settings:{centerMode:!0,centerPadding:"30px",slidesToShow:3,slidesToScroll:3}},{breakpoint:768,settings:{centerMode:!0,centerPadding:"30px",slidesToShow:2,slidesToScroll:2}}]}),/* Handle mobile nav and search */
