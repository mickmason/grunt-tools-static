...
d.stop().fadeOut(f,function(){c.fadeIn(f,function(){b.removeClass("active")})}),e.stop().slideUp(g,function(){})):(c.stop().fadeOut(f,function(){d.fadeIn(f,function(){b.addClass("active")})}),e.stop().slideDown(f,function(){console.log("animage d")}))})}(window);