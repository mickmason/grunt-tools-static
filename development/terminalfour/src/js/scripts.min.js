...
$(document).on("click",'[data-toggle="lightbox"]',function(a){a.preventDefault(),$(this).ekkoLightbox({width:"66%",height:"800px",onContentLoaded:function(a){console.log("Loaded"),console.log(a.toString())}})}),/* Handle mobile nav and search */
