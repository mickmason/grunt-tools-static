...
$("#search-submit-button").on("click",function(a){a.preventDefault(),$("#dfa-site-search-input").submit()}),$("#dfa-site-search-input").on("focus",function(a){var b=$(this).attr("placeholder");$(this).attr("placeholder",""),$(this).on("blur",function(a){$(this).attr("placeholder",b)})}),$(".hero-text")&&(console.log("there is a hero text element"),window.outerWidth>768)){var c=$(".hero-text"),d=c.attr("data-posx")?c.attr("data-posx"):50,e=c.attr("data-posy")?c.attr("data-posy"):50,f=c.attr("data-align")?c.attr("data-align"):"centre";c.css({left:d+"%",top:e+"%",textAlign:f}),$(a).on("resize",function(){c.css({left:d+"%",top:e+"%",textAlign:f})})}/**!
     ...
     */
$(".feature-bottom-opener .dfa-icon__with-label").on("click",function(a){a.stopPropagation();var b=$(this),c=b.find(".feature-more"),d=b.find(".feature-less"),e=$(".featured-content-section-body .featured-content-block"),f=180,g=450;b.hasClass("active")?(/* Hide feature bottom */
