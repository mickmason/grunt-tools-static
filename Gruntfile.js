  ...
  grunt.initConfig({
    ...
    */
    ...
    concat: {
        ...
        dist: {
          src: ['development/lib/jquery-3.1.1/jquery-3.1.1.min.js', 'development/lib/bootstrap.min.js', 'development/lib/slick/slick/slick.min.js', 'development/terminalfour/src/js/scripts.js'],
