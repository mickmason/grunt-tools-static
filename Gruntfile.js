  ...
  grunt.initConfig({
    ...
    */
    ...
    concat: {
        ...
        dist: {
          src: ['development/lib/jquery-ui/jquery-ui.min.js',  'development/lib/bootstrap.min.js', 'development/lib/jquery-validate-1.16.0/jquery.validate-1.16.0.min.js', 'development/lib/slick/slick/slick.min.js', 'development/lib/jquery-match-height/jquery.matchHeight.js', 'development/lib/ekko-lightbox/ekko-lightbox.js', 'development/terminalfour/src/js/scripts.js'], 
